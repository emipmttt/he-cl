  ...
  <div class="card-panel">
    ...
    <div v-if="showCampain">
      <table class="striped">
        <thead>
          <tr>
            <th> <i class="material-icons left">assignment_turned_in</i> Campaña</th>
  ...
  <div id="createCampain" class="modal modal-fixed-footer" style="overflow-x: hidden">
    <form @submit.prevent="send">
      <div class="modal-content" style="overflow-x: hidden">
        <h4> <i class="material-icons">add</i> Crear campaña</h4>
        <p>Nueva campaña para <strong class="indigo-text">{{name}}</strong></p>
        <p>Una nueva campaña clonará el <strong>cuestionario base actual</strong> y posteriormente podrá ser
          modificado</p>
        <div class="row">
          <div class="col s12">
