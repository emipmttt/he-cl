  ...
  methods: {
    send() {
      ...
      let data = {
        ...
        timer: this.timer,
        user: this.campain.user,
        campain: this.urlToString(this.campain.campainName)
      };
      console.log(data);
      axios.post('https://clima-laboral.human-express.com/php/campains/update.php', this.createFormData(data))
        .then(response => {
    ...
    deleteElement() {
      ...
      if (confirm("Haz click en Aceptar para eliminar el reactivo")) {
        ...
        axios.post("https://clima-laboral.human-express.com/php/campains/delete.php", this.createFormData(data))
          .then(element => {
            M.toast({
