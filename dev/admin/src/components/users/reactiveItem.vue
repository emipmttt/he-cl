...
export default {
  ...
  methods: {
    send() {
      ...
      console.log(data);
      axios.post('https://nom035.human-express.com/php/campains/update.php', this.createFormData(data))
        .then(response => {
    ...
    deleteElement() {
      ...
      if (confirm("Haz click en Aceptar para eliminar el reactivo")) {
        ...
        axios.post("https://nom035.human-express.com/php/campains/delete.php", this.createFormData(data))
          .then(element => {
            M.toast({
