  ...
  <div>
    <form @submit.prevent="send">
      ...
      <div class="input-field">
        ...
        <input
          class="validate"
          v-bind:id="'recommendations' + aspectId"
    ...
    <table>
      ...
      <tbody>
        <tr
          ...
          @update:change="get"
          :key="textualRange.id"
          v-for="textualRange in textualRanges"
...
export default {
  ...
  methods: {
    send() {
      ...
      axios
        .post(
          "https://clima-laboral.human-express.com/php/textualRanges/create.php",
    ...
    get() {
      axios
        .get(
          "https://clima-laboral.human-express.com/php/textualRanges/read.php?query=dependency&dependency=" +
            this.aspectId +
            "&typeDependency=aspect"
        )
        .then(response => {
